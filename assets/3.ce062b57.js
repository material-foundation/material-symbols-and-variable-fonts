import{r as d,s as f,$ as u,n as v,o as h,i as g,e as m}from"./vendor.8226bdf7.js";import"./slider-control.ab10962b.js";import"./step-layout.c15fdb61.js";import"./width.3d902cbb.js";import"./phone-mockup.fd2bfa1c.js";import{c as w}from"./utilities.02bf2a00.js";import"./if-defined.2ec4fe38.js";import"./directive.9b57a945.js";import"./next-button.1a74693d.js";var y=Object.defineProperty,x=Object.getOwnPropertyDescriptor,b=(t,e,s,i)=>{for(var o=i>1?void 0:i?x(e,s):e,r=t.length-1,n;r>=0;r--)(n=t[r])&&(o=(i?n(e,s,o):n(o))||o);return i&&o&&y(e,s,o),o};let p=class extends f{render(){return u`
      <phone-mockup>
        <div class="content">
  ...
  `;p=b([v("example-text")],p);var C=Object.defineProperty,S=Object.getOwnPropertyDescriptor,c=(t,e,s,i)=>{for(var o=i>1?void 0:i?S(e,s):e,r=t.length-1,n;r>=0;r--)(n=t[r])&&(o=(i?n(e,s,o):n(o))||o);return i&&o&&C(e,s,o),o};const a={"--font-family":"RobotoFlex","--wdth":"110","--wght":"400"};let l=class extends f{constructor(){super(...arguments);this.useSerif=!1}setStyle(t,e){this.main.style.setProperty(t,e),a[t]=e,this.requestUpdate()}getStyle(t){var s;const e=(s=this.main)==null?void 0:s.style;if(e){const i=e==null?void 0:e.getPropertyValue(t);if(i)return i}return a[t]}switchSerif(){this.useSerif=!this.useSerif,this.setStyle("--font-family",this.useSerif?"RobotoSerif":"RobotoFlex")}firstUpdated(){for(const[t,e]of Object.entries(a))this.setStyle(t,e)}render(){const{useSerif:t}=this;return u`<section>
      <step-layout
        stepCount="3"
        totalSteps="8"
      ...
      >
        ...
        <div slot="options">
          <width-font-control
            ...
            @value=${e=>{const s=e.detail.value;this.setStyle("--wdth",s)}}
          ></width-font-control>
          <weight-font-control
            .value=${this.getStyle("--wght")}
            @value=${e=>{const s=e.detail.value;this.setStyle("--wght",s)}}
          >
          </weight-font-control>
        </div>
        <div class="demo" slot="preview"><example-text></example-text></div>
      </step-layout>
    </section>`}generateCode(){const t=[];return t.push(".text {","    font-variation-settings:",`        \u201Cwght\u201D  ${this.getStyle("--wght")},`,`        \u201Cwdth\u201D  ${this.getStyle("--wdth")};`,`    font-family: ${this.getStyle("--font-family")};`,"    font-size: 100px;","}"),t.join(`
`)}};l.styles=d`
    ${w}
    .demo {
      --font-family: ${h(a["font-family"])};
      --wdth: ${h(a["--wdth"])};
      --wght: ${h(a["--wght"])};
    }
  ...
  `;c([g(".demo")],l.prototype,"main",2);c([m({type:Boolean})],l.prototype,"useSerif",2);l=c([v("step-three")],l);export{l as StepThree};
