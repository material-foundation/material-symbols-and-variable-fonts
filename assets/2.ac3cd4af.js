import{s as c,$ as p,r as d,o as h,i as u,e as w,n as b}from"./vendor.8226bdf7.js";import"./step-layout.40e1b7fd.js";import"./width.75021a1a.js";import"./tab-button.cfea5da5.js";import{c as g}from"./utilities.ebb9f1dd.js";import"./next-button.1a74693d.js";import"./directive.9b57a945.js";import"./slider-control.ab10962b.js";import"./if-defined.2ec4fe38.js";var m=Object.defineProperty,v=Object.getOwnPropertyDescriptor,f=(e,t,o,i)=>{for(var s=i>1?void 0:i?v(t,o):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(s=(i?l(t,o,s):l(s))||s);return i&&s&&m(t,o,s),s};const r={"--font-family":"RobotoFlex","--wdth":"110","--wght":"400"};let n=class extends c{constructor(){super(...arguments);this.useSerif=!1}setStyle(e,t){this.main.style.setProperty(e,t),r[e]=t,this.requestUpdate()}getStyle(e){var o;const t=(o=this.main)==null?void 0:o.style;if(t){const i=t==null?void 0:t.getPropertyValue(e);if(i)return i}return r[e]}switchSerif(){this.useSerif=!this.useSerif,this.setStyle("--font-family",this.useSerif?"RobotoSerif":"RobotoFlex")}firstUpdated(){for(const[e,t]of Object.entries(r))this.setStyle(e,t)}render(){const{useSerif:e}=this;return p`<section>
      <step-layout
        stepCount="2"
        totalSteps="8"
